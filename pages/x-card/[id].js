...
export default function XCardPage() {
  ...
  return (
    <>
      ...
      <style jsx>{`
        :root{ --pink:#ff51b3; --violet:#b57eff; --cyan:#b5fffc; }
        html,body,#__next{height:100%} body{margin:0;background:#0b0512;color:#fff}
        .wrap{min-height:100%; display:flex; align-items:center; justify-content:center; padding:20px;}
        .card{ position:relative; width:min(100%,1500px); aspect-ratio:3/1; border-radius:16px; overflow:hidden;
        ...
        .glow{ position:absolute; inset:0; background:radial-gradient(circle at 60% 50%, rgba(255,255,255,.10) 0%, rgba(255,255,255,0) 62%); }
        .content{ position:relative; height:100%; width:100%; display:flex; flex-direction:column; justify-content:center; gap:18px;
                  padding:40px 60px 40px 520px; text-shadow:0 1px 0 #000, 0 8px 26px rgba(0,0,0,.45); }
        .content.center{ padding:60px; align-items:center; text-align:center; }
        .content.compact :global(.title){ font-size:76px; } .content.compact :global(.who){ font-size:62px; }
        .content.compact :global(.chip){ padding:10px 16px; font-size:30px; border-width:3px; }
        .title{ font-size:86px; font-weight:1000; text-shadow:0 1px 0 #000, 0 12px 34px rgba(250,26,129,.28), 0 6px 24px rgba(181,126,255,.26); }
        .bar{ height:6px; width:260px; border-radius:999px; margin-top:6px;
              background:linear-gradient(90deg,var(--pink),var(--violet),var(--cyan)); box-shadow:0 6px 20px rgba(181,126,255,.35); opacity:.55; }
        .who{ font-size:70px; font-weight:1000; line-height:1.06; max-width:90%; }
        .chips{ display:flex; flex-wrap:wrap; gap:22px; }
        .chip{ display:flex; align-items:baseline; gap:12px; padding:12px 20px; border-radius:999px; font-size:34px; font-weight:900;
        ...
        .k{ opacity:.78; font-weight:800; } .v{ font-weight:1000; }
        .tagline{ font-size:34px; font-weight:900; margin-top:6px; }
        .wm{ position:absolute; right:28px; bottom:22px; padding:8px 14px; border-radius:999px;
        ...
        @media (max-width:900px){
          .content{ padding:24px; } .title{ font-size:46px; } .who{ font-size:40px; }
          .chip{ font-size:22px; padding:8px 14px; border-width:2px; } .bar{ height:4px; width:180px; }
        }
      `}</style>
    </>
  );
